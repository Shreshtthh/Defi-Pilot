...
type QueryType = 
  | 'simple_deposit'      // "Deposit 100 USDC to Morpho"
  | 'simple_withdraw'     // "Withdraw from position 0"
  | 'portfolio_check'     // "Show my portfolio"
  | 'research_simple'     // "What are top protocols on Base?"
...
export class QueryRouter {
  ...
  private static protocols = [
    'morpho', 'aave', 'compound', 'uniswap', 'curve', 
    'yearn', 'balancer', 'convex', 'frax'
  ];
...
Would you like to proceed with execution?`,
      ...
      case 'conversation':
        const greetings: Record<string, string> = {
          'hello': '👋 Hello! I can help you deposit funds into DeFi protocols. Try saying "Deposit 100 USDC to Morpho"',
          'hi': '👋 Hi! Ready to help you with DeFi strategies. What would you like to do?',
          'hey': '👋 Hey there! Ask me about yields or deposit funds.',
          'thanks': '😊 You\'re welcome! Let me know if you need anything else.',
          'help': '🤖 I can help you:\n• Deposit funds to DeFi protocols\n• Check yields and protocols\n• View your portfolio\n\nTry: "Deposit 50 USDC to Morpho"'
        };
