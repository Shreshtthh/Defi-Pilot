...
export const simulateDepositTool = createTool({
  ...
  description: 'Simulates a DeFi deposit transaction on Base Sepolia testnet to estimate gas costs and verify execution',
  schema: z.object({
    ...
    try {
      ...
      return JSON.stringify({
        ...
        simulation: {
          ...
          warning: 'This is a testnet simulation. No real funds at risk.'
        }
      });
    } catch (error) {
      return JSON.stringify({
